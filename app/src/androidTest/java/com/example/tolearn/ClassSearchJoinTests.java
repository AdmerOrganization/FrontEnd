...
public class ClassSearchJoinTests {
    @Rule
    @JvmField
    public ActivityScenarioRule<ClassSearch> rule2 = new ActivityScenarioRule<ClassSearch>(ClassSearch.class);
    @Test
