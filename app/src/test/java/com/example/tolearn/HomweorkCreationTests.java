...
public class HomweorkCreationTests {
    @Test
    ...
    @Test
    public void IsDescCorrect2()
    {
        homework_creation_validations controller = new homework_creation_validations();
        boolean titleCorrect = controller.IsDescCorrect("1234avx");
        assertTrue(titleCorrect);
    }
    ...
    @Test
    public void IsDescCorrect5()
    {
        homework_creation_validations controller = new homework_creation_validations();
        boolean titleCorrect = controller.IsDescCorrect("1234");
        assertTrue(titleCorrect);
    }
    ...
    @Test
    public void IsDateValid1()
    {
        homework_creation_validations controller = new homework_creation_validations();
        boolean titleCorrect = controller.IsDateValid(1390 , 11 , 31);
        assertFalse(titleCorrect);
    }
    @Test
    ...
    @Test
    public void IsDateValid5()
    {
        homework_creation_validations controller = new homework_creation_validations();
        boolean titleCorrect = controller.IsDateValid(2023 , 10 , 31);
        assertTrue(titleCorrect);
    }
    @Test
